...
function renderMain(){
  ...
  const topButtons=`<div style="display:flex;gap:8px;padding:12px;background:var(--bg-surface);border-bottom:0.5px solid var(--border-mid);"><button onclick="window.currentViewMode='map';renderMain()" style="padding:6px 12px;background:`+(!window.currentViewMode||window.currentViewMode==='map'?'var(--color-primary)':'var(--bg-surface)')+`;color:var(--text-primary);border:0.5px solid `+(!window.currentViewMode||window.currentViewMode==='map'?'var(--color-primary)':'var(--border-mid)')+`;border-radius:4px;cursor:pointer;font-size:12px;font-weight:500;">📍 MAP</button><button onclick="window.currentViewMode='skills';renderMain()" style="padding:6px 12px;background:`+(window.currentViewMode==='skills'?'var(--color-primary)':'var(--bg-surface)')+`;color:var(--text-primary);border:0.5px solid `+(window.currentViewMode==='skills'?'var(--color-primary)':'var(--border-mid)')+`;border-radius:4px;cursor:pointer;font-size:12px;font-weight:500;">📚 SKILLS</button></div>`;
